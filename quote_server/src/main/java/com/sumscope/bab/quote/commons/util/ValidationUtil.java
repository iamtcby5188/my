...
public final class ValidationUtil {
     ...
     */
    public static <T> List<ValidationExceptionDetails> validateModelAndCollectConstraintsViolations(T model) {
    ...
    public static void setValidationException(List<ValidationExceptionDetails> validationExceptionDetailses) {
        if (validationExceptionDetailses.size() > 0) {
            throw new ValidationException(validationExceptionDetailses);
        }
    }

    public static void throwExceptionWithDetails(ValidationExceptionDetails validation) {
        List<ValidationExceptionDetails> detailsList = new ArrayList<>();
        detailsList.add(validation);
